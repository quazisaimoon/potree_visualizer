...
export class OrbitControls extends EventDispatcher{
	...
	update (delta) {
		...
		let moveForward = this.keys.FORWARD.some(e => this.viewer.inputHandler.pressedKeys[e]);
		let moveBackward = this.keys.BACKWARD.some(e => this.viewer.inputHandler.pressedKeys[e]);
		let moveLeft = this.keys.LEFT.some(e => this.viewer.inputHandler.pressedKeys[e]);
		let moveRight = this.keys.RIGHT.some(e => this.viewer.inputHandler.pressedKeys[e]);
