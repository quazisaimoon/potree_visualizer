...
export class Scene extends EventDispatcher{
	...
	addPath(path){
		path.lengthUnit = this.lengthUnit;
		path.lengthUnitDisplay = this.lengthUnitDisplay;
	...
	addArea(area){
		area.lengthUnit = this.lengthUnit;
		area.lengthUnitDisplay = this.lengthUnitDisplay;
	...
	removeAllWaypoints() {
		...
		while (this.areas.length > 0) {
			this.removeArea(this.areas[0]);
		}

		while (this.regions.length > 0) {
			this.removeRegion(this.regions[0]);
		}
	}
