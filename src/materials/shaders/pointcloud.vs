...
void doClipping(){
	...
	// #endif
		...
		for(int i = 0; i < num_noneboxes; i++){
			vec4 clipPosition = noneBoxes[i] * modelMatrix * vec4( position, 1.0 );
		...
		for(int i = 0; i < num_greenboxes; i++){
			vec4 clipPosition = greenBoxes[i] * modelMatrix * vec4( position, 1.0 );
		...
		for(int i = 0; i < num_redboxes; i++){
			vec4 clipPosition = redBoxes[i] * modelMatrix * vec4( position, 1.0 );
